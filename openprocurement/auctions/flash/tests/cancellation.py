...
from openprocurement.auctions.flash.tests.cancellation_blanks import (
    ...
    create_auction_lots_cancellation,
    patch_auction_lots_cancellation,
...
class AuctionLotsCancellationResourceTest(BaseAuctionWebTest):
    ...
    initial_bids = test_bids
    test_create_auction_lots_cancellation = snitch(create_auction_lots_cancellation)
    test_patch_auction_lots_cancellation = snitch(patch_auction_lots_cancellation)
